...
source("../functions/get_species_table.R")
```
...
species.table$class[species.table$species %in% subset(species.table, is.na(class) & clade == "Chordata")$species] <- c("Reptilia", "Reptilia")
```
